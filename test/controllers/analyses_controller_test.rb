...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference("Analysis.count") do
      post analyses_url, params: { analysis: { content: @analysis.content, user_id: @analysis.user_id } }
    end
  ...
  test "should update analysis" do
    patch analysis_url(@analysis), params: { analysis: { content: @analysis.content, user_id: @analysis.user_id } }
